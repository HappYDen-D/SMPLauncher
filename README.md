...
Адрес сервера: `industrialsmp.ddns.net:25842`.
...
- Полностью обновлены главный экран и фон.
- Добавлен отдельный режим INDUSTRIAL Launcher с Microsoft-входом.
- Добавлены скорость, объём и ETA для загрузок Minecraft, NeoForge, сборки, самообновления и публикации.
- Исправлен транспорт публикации на VPS: временные файлы, проверка размера и атомарная замена через проверенный SFTP-механизм.
- Удалён проблемный SSH-бэкенд, вызывавший ошибки обмена ключами и тайм-ауты.
...
<div align="center">
INDUSTRIAL SMP · Minecraft 1.21.1 · NeoForge · Launcher 0.7.7
</div>
